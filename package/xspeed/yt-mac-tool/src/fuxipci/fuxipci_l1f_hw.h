...
#define L1F_PCI_DID_GB                  BIT(0)
#define L1F_DEV_ID                      0x1091
#define L2F_DEV_ID                      0x1090
#define L1H_DEV_ID                      0x10A1
#define L2H_DEV_ID                      0x10A0

#define L1F_PCI_CMD                     0x0004  /* 16bit */
#define L1F_PCI_CMD_DISINT              BIT(10)
#define L1F_PCI_CMD_MASTEREN            BIT(2)
#define L1F_PCI_CMD_MEMEN               BIT(1)
#define L1F_PCI_CMD_IOEN                BIT(0)

#define L1F_PCI_STAT                    0x0006  /* 16bit */
#define L1F_PCI_STAT_PERR               BIT(15)
#define L1F_PCI_STAT_SERR               BIT(14)
#define L1F_PCI_STAT_RMABT              BIT(13)
#define L1F_PCI_STAT_RTABT              BIT(12)
#define L1F_PCI_STAT_STABT              BIT(11)
#define L1F_PCI_STAT_MDPERR             BIT(8)
#define L1F_PCI_STAT_INTS               BIT(3)
...
#define L1F_MDIO_CLK_SEL_MASK           ASHFT27(7UL)
...
#define L1F_MAC_CTRL                    0x0
#if 1
#define L1F_MAC_CTRL_LPBACK_EN          BIT(12)
#define L1F_MAC_CTRL_IPC_EN             BIT(27)
#else
...
#define L1F_CR_DMA_CTRL_BWCREDIT_MASK   ASHFT_19(0x3UL)
...
#define L1F_CR_DMA_CTRL_BW_RATIO_MASK   ASHFT_16(0x3UL)
...
#define L1F_CR_DMA_CTRL_RXTH_MASK       ASHFT_4(0xFUL)
#define L1F_CR_DMA_CTRL_WTH_MASK        ASHFT_0(0xFUL)
...
#define L1F_SYSMODCTRL_IECHOADJ_DEF         0xBBBB
#if 0
(\
...
#define L1F_TST10BTCFG_INTV_TIMER_SHIFT     ASHFT14
...
bool macaddr_valid(u8 __far *addr);
#endif
